...
<div class="report-sheet">
    <div class="report-header">
        <div class="report-title">{{ $showDetail ? 'LAPORAN DETAIL PEMBELIAN' : 'LAPORAN PEMBELIAN' }}</div>
    ...
    <table class="report-table">
        <thead>
            <tr>
                ...
                <th class="text-right" style="width: 110px;">Total Beli</th>
        ...
        <tbody>
            @forelse ($rows as $row)
                <tr>
                    ...
                    <td class="text-right">{{ $formatMoney($row['total_beli']) }}</td>
            ...
            @empty
                <tr>
                    <td colspan="11" class="muted text-center">Tidak ada data pembelian pada periode ini.</td>
                </tr>
            @endforelse
            <tr>
