<x-filament-panels::page>
    <style>
        ...
        .report-filter-grid {
            display: grid;
            grid-template-columns: minmax(0, 180px) minmax(0, 180px) minmax(0, 220px) minmax(0, 140px) auto;
            gap: 0.75rem;
            align-items: end;
        }
    ...
    <div class="purchase-report-page">
        <div class="report-filter no-print">
            <div class="report-filter-grid">
                ...
                <div class="report-field">
                    ...
                    <select id="supplier_id" wire:model="supplierId">
        ...
        <div class="report-preview">
            @include('reports.partials.purchase-report-table', [
                'company' => $company,
