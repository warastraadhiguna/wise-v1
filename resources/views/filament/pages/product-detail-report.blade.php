<x-filament-panels::page>
    <style>
        ...
        .report-filter-grid {
            display: grid;
            grid-template-columns: minmax(0, 320px) minmax(0, 180px) minmax(0, 180px) auto;
            gap: 0.75rem;
            align-items: end;
        }
    ...
    <div class="product-detail-report-page">
        ...
        <div class="report-preview">
            @include('reports.partials.product-detail-report-table', [
                'company' => $company,
