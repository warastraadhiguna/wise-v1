<x-filament-panels::page>
    <style>
        ...
        .report-filter-grid {
            display: grid;
            grid-template-columns: minmax(0, 180px) minmax(0, 180px) minmax(0, 260px) minmax(0, 220px) auto;
            gap: 0.75rem;
            align-items: end;
        }
    ...
    <div class="ledger-report-page">
        <div class="report-filter no-print">
            <div class="report-filter-grid">
                ...
                <div class="report-field">
                    <label for="ref_type">Jenis Mutasi</label>
                    <select id="ref_type" wire:model="refType">
                        ...
                        <option value="PURCHASE_RETURN_DETAIL_DELETE">Batal Detail Retur Pembelian</option>
                        <option value="SALE_RETURN_DETAIL_DELETE">Batal Detail Retur Penjualan</option>
                    </select>
                </div>
